...
<body onload='init()'>
     <iframe  class='iframe_head' src="http://cvpmdsip02/phasereview/webHead.aspx?system=LVM&item=Data collection&user=" frameborder="0"></iframe>
     <div class='head'><%--value='54-81-01850-4LAA'--%>
       PN<input class='inp'  /> Lot<input class='inp lot' /> BD<input class='inp' />Test<input class='inp test' /> From Time<input onclick="calendar(this)" class='inp time dd1' /> To Time<input onclick="calendar(this)"  class='inp time dd2'/> <button  class='but_sub'>Search</button>
