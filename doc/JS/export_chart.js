...
this.Show_Chart = function () {
    ...
    var options = { chart: { renderTo: this.Chart_Box, backgroundColor: ''//,plotBackgroundImage: 'http://www.highcharts.com/demo/gfx/skies.jpg', backgroundColor: 'rgba(0,0,0,0)'
        ...
        xAxis: { categories: [], labels: { step: this.X_step } },
        plotOptions: {
